...
public:
  ...
  // Read raw accelerometer and gyroscope values into a buffer.
  // The provided buffer must have been previously allocated.
  // Buffer order: accelerometer XYZ temperature gyroscope XYZ
  void readRawValues(uint8_t *buffer);
